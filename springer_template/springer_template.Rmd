...
```{r chunk_888, echo = FALSE, eval = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", cache = TRUE, eval = FALSE}
# Circles <- lapply(1:64, function(x) {
...
```{r chunk_8, echo = FALSE, fig.height = 3, fig.width = 3, fig.align = "center"}
load("pp_last.dat")
pp_last$plot
```
