...
```{r chunk_1, echo = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", message = FALSE}
set.seed(1)
...
```{r chunk_2_5, echo = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", cache = TRUE}
change_of_point1 <- cpbaywave::bootJLDetectChangePoint(dists_1, rotate_xaxis = TRUE, returnPlot = TRUE)
```


```{r chunk_3, echo = FALSE, message=FALSE, fig.height = 3, fig.width = 5, fig.align = "center",  cache = TRUE}
library(cowplot)
...
```{r chunk_4, echo = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", cache = TRUE}
...
```{r chunk_4_5, echo = FALSE, message=FALSE, fig.height = 3, fig.width = 5, fig.align = "center",  cache = TRUE}
library(cowplot)
...
```{r chunk_5, echo = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", cache = TRUE}
dd_2 <- function(x,y) {
  sum((x-y)^4)^1/4
}
...
```{r chunk_5_5, echo = FALSE, message=FALSE, fig.height = 3, fig.width = 5, fig.align = "center",  cache = TRUE}
library(cowplot)
...
```{r chunk_6, echo = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", cache = TRUE, message = FALSE}
library(TDA)
library(cpbaywave)
library(dplyr)
library(ggplot2)
...
```{r chunk_7, echo = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", cache = TRUE}
...
We see that the change point detection algorithm detects approximately when there are three distinct loops. Note that in this case, we only used 1-dimensional homology, so it would not be able to detect changes in clusters. [Link here](http://stat.slu.edu/~speegle/two_circles.gif)

```{r chunk_7_5, echo = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", cache = TRUE}
pp$plot
```
...
```{r chunk_8, echo = FALSE, eval = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", cache = TRUE, eval = FALSE}
# Circles <- lapply(1:64, function(x) {
...
```{r chunk_10, echo = FALSE, eval = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", cache = TRUE}
load("circleData.dat")
Circles <- circs
N <- 64
Diags <- lapply(1:N, function(i) ripsDiag(X = Circles[[i]],
...
```{r chunk_10_5, echo = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", cache = TRUE, message=FALSE}
i <- 1
   library(grid)
library(imager)
im <- png::readPNG(paste0("/Users/speegled/Downloads/E00/Frame00", i, ".png"))
...
```{r chunk_11, echo = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", cache = TRUE}
...
```{r chunk_12, echo = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", cache = TRUE}
load("circleData2.dat")
df1 <-  as.data.frame(p$sigindices, stringsAsFactors = FALSE)
